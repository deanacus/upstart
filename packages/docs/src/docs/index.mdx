...
<Table>
  ...
  <TableRow>
    ...
    <TableCell><Status status="review" /> <small>In Review</small></TableCell>
    <TableCell><Status status="progress" /> <small>In Progress</small></TableCell>
  </TableRow>
  <TableRow>
    <TableCell>Core Typography</TableCell>
    <TableCell><Status status="complete" /> <small>Complete</small></TableCell>
    <TableCell><Status status="progress" /> <small>In Progress</small></TableCell>
  </TableRow>
  </tbody>
</Table>
...
<Table>
  ...
  <TableRow>
    ...
    <TableCell><Status status="progress" /> <small>In Progress</small></TableCell>
    <TableCell><Status status="planned" /> <small>Planned</small></TableCell>
  </TableRow>
  <TableRow>
